...
<div class="skills-container">
  ...
  <div class="skill-category">
    ...
    <div class="skills-tags">
      ...
      <span class="skill-tag expert">MS Excel</span>
      <span class="skill-tag advanced">Alteryx</span>
      <span class="skill-tag intermediate">Axure</span>
      <span class="skill-tag advanced">Stata</span>
      <span class="skill-tag intermediate">MATLAB</span>
    </div>
    <div class="skills-tags">
      <span class="skill-tag advanced">A/B Testing</span>
      <span class="skill-tag advanced">Statistical Inference</span>
      <span class="skill-tag intermediate">Web Scraping</span>
      <span class="skill-tag intermediate">Text Mining</span>
    </div>
  </div>
  ...
  <div class="skill-category">
    ...
    <div class="skills-tags">
      ...
      <span class="skill-tag">Monte Carlo</span>
...
.skill-tag.cert {
  background: linear-gradient(135deg, var(--global-theme-color), #6c757d);
  color: white;
  border-color: var(--global-theme-color);
  font-weight: 600;
}
